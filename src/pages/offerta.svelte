<Page name={page.name}>
    ...
    <Block strong inset class="pc_center pc_l_width vanta_globe">
      <BlockTitle>La massima velocità</BlockTitle>
      Applicazioni web veloci e reattive, per poter lavorare al meglio senza interruzioni.
    </Block>
    ...
    <Block strong inset class="pc_center pc_l_width vanta_globe">
        <BlockTitle>Sicurezza</BlockTitle>
        Teniamo in sicurezza tutti i dati della tua applicazione criptandoli tramite algoritmi sicuri, efficienti e veloci, permettendo la
        reperibilità senza lunghi tempi e la massima sicurezza. 
    </Block>
